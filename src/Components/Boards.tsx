...
const Boards = () => {
	...
	return (
		<div className="board-container">
			{activeBoard && activeBoard.columns.map((column, index) => <BoardColumn key={index} column={column} openTaskModal={openTaskModal} />)}
			<div className="add-column-btn">
				<h2 className="heading-XL">+ New Column</h2>
			</div>
			{activeTaskView.task && activeTaskView.column && <ViewTask currTask={activeTaskView.task} currColumn={activeTaskView.column} closeTaskModal={closeTaskModal} />}
		</div>
	);
};
