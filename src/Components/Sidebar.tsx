		...
		<div className="sidebar-container">
			...
			<div className="board-selector-container">
				{boards.map((board, index) => (
					<div key={index} className={`board-selector ${index === activeBoardIndex ? "selected" : ""}`}>
				...
				<div className="board-selector create-board-btn">
					<div className="selector-content-container">
						<div className="icon-container">
			...
			<div className="board-selector-container hide-sidebar-container">
